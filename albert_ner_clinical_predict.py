...
class NerProcessor(DataProcessor):
  ...
  def get_labels(self):
    ...
    #return ['O','SIGNS-B','SIGNS-I','DISEASE-B','DISEASE-I','BODY-B','BODY-I','CHECK-B','CHECK-I','TREATMENT-B','TREATMENT-I',                            'X','[CLS]','[SEP]']

    return ['I-DISEASE', 'I-SIGNS', 'I-TREATMENT', 'I-BODY', 'B-SIGNS', 'O', 'B-CHECK', 'B-DISEASE', 'B-BODY', 'I-CHECK', 'B-TREATMENT',"X","[CLS]","[SEP]"]
...
def create_model(bert_config, is_training, input_ids, input_mask, segment_ids,
  ...
  with tf.variable_scope("loss"):
    ...
    logits = tf.reshape(logits, [-1, FLAGS.max_seq_length, output_num]) #11
...
def main(_):
  ...
  print(FLAGS.bert_config_file,'bert_config_file')
